...
(0, 1, 'CREATE', 'sales', 9, NULL, '{\"total\": 1.12, \"payment_method\": \"Cash\", \"sale_date\": \"2025-12-01 00:17:41\"}', '2025-11-30 16:17:41'),
(0, 1, 'UPDATE', 'products', 52, '{\"stock\": 1, \"price\": 1.00}', '{\"stock\": 0, \"price\": 1.00}', '2025-11-30 16:17:41'),
(0, 1, 'CREATE', 'sales', 9, NULL, NULL, '2025-11-30 16:17:41'),
(0, 1, 'CREATE', 'sales', 10, NULL, '{\"total\": 5376.00, \"payment_method\": \"Cash\", \"sale_date\": \"2025-12-01 00:18:08\"}', '2025-11-30 16:18:08'),
(0, 1, 'UPDATE', 'products', 51, '{\"stock\": 50, \"price\": 800.00}', '{\"stock\": 44, \"price\": 800.00}', '2025-11-30 16:18:08'),
(0, 1, 'CREATE', 'sales', 10, NULL, NULL, '2025-11-30 16:18:08');
...
CREATE TABLE `low_stock_products` (
  ...
  `shortage` bigint(12) DEFAULT NULL,
  `category_name` varchar(100) DEFAULT NULL,
...
(51, 5, 'Gard Shampoo', NULL, 'GRDSHM1', 800.00, 5000.00, 44, 10, '2028-12-30', 0, '2025-11-30 15:53:52', '2025-11-30 16:18:08'),
(52, 2, 'joey tomboy', 'fsfsafas', 'joeylami', 1.00, 1.00, 0, 10, '2025-12-04', 0, '2025-11-30 16:11:55', '2025-11-30 16:17:41');
...
(9, 1, NULL, '2025-11-30 16:17:41', 1.00, 0.00, 0.12, 1.12, 12424.00, 12422.88, 'Cash', 'tangninamoyawa'),
(10, 1, NULL, '2025-11-30 16:18:08', 4800.00, 0.00, 576.00, 5376.00, 12213131.00, 12207755.00, 'Cash', NULL);
