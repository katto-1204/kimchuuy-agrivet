...
import type { User, Category, Product, Supplier, Customer, Sale, Delivery, DashboardStats } from "./types"
...
export const mockCategories: Category[] = [
  { category_id: 1, name: "Feeds", description: "Animal feeds and food products" },
  { category_id: 2, name: "Medicine", description: "Veterinary medicines and treatments" },
  { category_id: 3, name: "Vitamins", description: "Supplements and vitamins" },
  { category_id: 4, name: "Accessories", description: "Pet and farm accessories" },
  { category_id: 5, name: "Others", description: "Miscellaneous items" },
]
...
export function getExpiringProducts(): Product[] {
